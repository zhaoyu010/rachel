...
class DialogCurrentPlaylist(fragment: FragmentMusic) : RachelBottomDialog<DialogCurrentPlaylistBinding, FragmentMusic>(fragment, 0.6f) {
    class Adapter(private val dialog: DialogCurrentPlaylist) : RachelAdapter<ItemPlaylistBinding, String>() {
    ...
    fun update(currentPlaylist: Playlist, currentMusicInfo: MusicInfo): DialogCurrentPlaylist {
