...
import com.yinlin.rachel.databinding.DialogLyricsInfoBinding
...
class DialogLyricsInfo(fragment: FragmentMusic) : RachelBottomDialog<DialogLyricsInfoBinding, FragmentMusic>(fragment, 0.5f) {
    class Adapter(private val dialog: DialogLyricsInfo) : RachelAdapter<ItemLyricsInfoBinding, LyricsInfo>() {
    ...
    override fun bindingClass() = DialogLyricsInfoBinding::class.java
    ...
    fun update(engineNames: LyricsInfoList): DialogLyricsInfo {
